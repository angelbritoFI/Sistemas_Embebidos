...
pwm = GPIO.PWM(32, 50000) # Inicializar pin 32 como PWM a una frecuencia de 50000 Hz

print("Iniciando PWM")
pwm.start(50) # Establecer ciclo de trabajo al 50% para que parpadeé cada 500 ms
print("PWM iniciado")
flag = True
